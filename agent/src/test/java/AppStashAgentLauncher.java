...
public class AppStashAgentLauncher {

    private static synchronized void lunch(String[] args) {
        try {
    ...
    private static File generateAgentJar() throws Exception {
        ...
        try {
            ...
            final File jarFile = File.createTempFile(AppStashAgentLauncher.class.getSimpleName(), ".jar");
    ...
    private static Class getVirtualMachineClassFromClassLoader() throws ClassNotFoundException {
        return AppStashAgentLauncher.class.getClassLoader().loadClass("com.sun.tools.attach.VirtualMachine");
    }
    ...
    static void addToolsJarToClassPath() throws Exception {
        ...
        try {
            ...
            addURL.invoke(AppStashAgentLauncher.class.getClassLoader(), url);
    ...
    public static void main(String[] args) throws Exception {
        AppStashAgentLauncher.lunch(args);
