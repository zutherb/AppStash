...
export TARGET_DIR=/usr/share/shop/frontend/html/api/recommendation
...
mongoexport -d shop -c recommendation.preference --csv --fields userId,articleId,preference --out "$RAW_FILE"
